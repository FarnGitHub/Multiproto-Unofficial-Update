...
public class RecipeParityHelper {
    ...
    public static void applyParity() {
        ...
        replaceBefore(ProtocolVersion.BETA_11,
                new ItemStack(Block.LADDER, 2), new ItemStack(Block.LADDER, 1), "# #", "###", "# #", '#', Item.STICK);
        // < b1.4
        removeBefore(ProtocolVersion.BETA_10, new ItemStack(Item.COOKIE, 8));
        // < b1.3
        ...
        // < b1.2
        removeBefore(ProtocolVersion.BETA_8, new ItemStack(Item.CAKE), new ItemStack(Block.DISPENSER), new ItemStack(Block.NOTE_BLOCK),
        ...
        if (ProtocolVersionManager.isBeforeWithAlphaPlace(ProtocolVersion.BETA_8)) {
    ...
    public static void replaceBefore(ProtocolVersion target, ItemStack output, Object... recipe) {
        replaceBefore(target, output, output, recipe);
    }

    public static void replaceBefore(ProtocolVersion target, ItemStack oldOutput, ItemStack output, Object... recipe) {
    ...
    public static void removeBefore(ProtocolVersion target, ItemStack... outputs) {
        if (ProtocolVersionManager.isBeforeWithAlphaPlace(target)) {
